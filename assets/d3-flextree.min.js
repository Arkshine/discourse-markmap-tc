!(function (t, e) {
  ...
  function n(t, e) {
    let n,
      ...
      s = [a];
    for (null == e && (e = r); (n = s.pop()); ) {
      if ((f && (n.value = +n.data.value), (h = e(n.data)) && (c = h.length))) {
        for (n.children = new Array(c), l = c - 1; l >= 0; --l) {
          s.push((i = n.children[l] = new u(h[l]))),
            (i.parent = n),
            (i.depth = n.depth + 1);
        }
      }
    }
    return a.eachBefore(o);
  }
  function r(t) {
    return t.children;
  }
  ...
  u.prototype = n.prototype = {
    ...
    eachAfter: function (t) {
      for (var e, n, r, i = this, o = [i], u = []; (i = o.pop()); ) {
        if ((u.push(i), (e = i.children))) {
  ...
  function g(t) {
    ...
    function o() {
      ...
      return (function (n) {
        function r(t) {
          return (
            l(this, r),
            f(this, (r.__proto__ || Object.getPrototypeOf(r)).call(this, t))
          );
        }
        return (
          a(r, n),
            ...
            [
              {
                key: "copy",
                value: function () {
                  let t = u(this.constructor, this, function (t) {
                    return t.children;
                  });
                  return (
                    t.each(function (t) {
              ...
              },
              {
                ...
                get: function () {
                  return (this.children || []).reduce(function (t, e) {
                    return r.maxExtents(t, e.extents);
                  }, this.nodeExtents);
                },
              },
              {
      ...
      return (function e(r, i) {
        ...
        return (
          ...
          o.children &&
            Object.assign(
              o,
              o.children.reduce(function (t, e) {
                return {
    ...
    return (
      Object.assign(i, {
        ...
        hierarchy: function (t, n) {
          let r = void 0 === n ? e.children : n;
          return u(o(), t, r);
        },
        dump: function (t) {
          let e = r("nodeSize");
  ...
  var v = function t(e) {
        ...
        (e.children || []).reduce(
          function (n, r) {
            let i = s(n, 2),
              ...
              u = i[1];
            t(r, e.y + e.ySize);
            let h = (0 === o ? r.lExt : r.rExt).bottom;
            return 0 !== o && m(e, o, u), [o + 1, j(h, o, u)];
          },
          [0, null]
        ),
        x(e),
    ...
    y = function t(e, n, r) {
      void 0 === n && ((n = -e.relX - e.prelim), (r = 0));
      let i = n + e.relX;
      return (
        (e.relX = i + e.prelim - r),
        (e.prelim = 0),
    ...
    m = function (t, e, n) {
      for (
        ...
        let a =
          ...
          h.xSize / 2 +
          o.spacing(h);
        (a > 0 || (a < 0 && c)) && ((l += a), b(i, a), E(t, e, n.index, a)),
          (c = !1);
        let f = o.bottom,
          s = h.bottom;
        f <= s && (o = k(o)) && (u += o.relX),
    ...
    E = function (t, e, n, r) {
      ...
      if (o > 1) {
        let u = r / o;
        (t.children[n + 1].shift += u), (i.shift -= u), (i.change -= r - u);
      }
    },
    X = function (t) {
      return t.hasChildren ? t.firstChild : t.lThr;
    },
    k = function (t) {
      return t.hasChildren ? t.lastChild : t.rThr;
    },
    z = function (t, e, n, r) {
      let i = t.firstChild,
        o = i.lExt,
        u = t.children[e];
      o.lThr = n;
      let h = r - n.relX - i.lExtRelX;
      (o.relX += h),
        (o.prelim -= h),
        (i.lExt = u.lExt),
        (i.lExtRelX = u.lExtRelX);
    },
    w = function (t, e, n, r) {
      let i = t.children[e],
        o = i.rExt,
        u = t.children[e - 1];
      o.rThr = n;
      let h = r - n.relX - i.rExtRelX;
      (o.relX += h),
        (o.prelim -= h),
        (i.rExt = u.rExt),
        (i.rExtRelX = u.rExtRelX);
    },
    S = function (t) {
      if (t.hasChildren) {
        let e = t.firstChild,
  ...
  (t.flextree = g), Object.defineProperty(t, "__esModule", { value: !0 });
});
