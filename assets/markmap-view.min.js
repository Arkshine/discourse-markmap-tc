  ...
  class St {
    ...
    renderData(t) {
      ...
      const {
        ...
        l = nt({})
          .children((t) => {
            let e;
            if (!(null == (e = t.payload) ? void 0 : e.fold)) {
              return t.children;
            }
          })
          .nodeSize((t) => {
      ...
      Object.assign(this.state, { minX: p, maxX: m, minY: f, maxY: g }),
        a && this.fit();
      const y = (t && h.find((e) => e.data === t)) || c,
        v = y.data.state.x0 ?? y.x,
        x = y.data.state.y0 ?? y.y,
        ...
        b = k
          ...
          .attr(
            "transform",
            (t) =>
              `translate(${x + y.ySize - t.ySize},${v + y.xSize / 2 - t.xSize})`
          ),
      ...
      S.select("line")
        ...
        S.attr(
          "transform",
          (t) =>
            `translate(${y.y + y.ySize - t.ySize},${
              y.x + y.xSize / 2 - t.xSize
            })`
        ).remove();
      ...
      const j = this.g
        ...
        .join(
          (t) => {
            const e = [x + y.ySize - n, v + y.xSize / 2];
            return t
              .insert("path", "g")
          ...
          (t) => t,
          (t) => {
            const e = [y.y + y.ySize - n, y.x + y.xSize / 2];
      ...
      this.transition(j)
        ...
        .attr("stroke-width", (t) => vt(t.target))
        .attr("d", (t) => {
          const e = t.source,
            r = t.target,
    ...
    async ensureView(t, n) {
      ...
      const o = this.svg.node(),
        ...
        y = f[0] * f[1] > 0 ? xt(f, Math.abs) / c.k : 0,
        v = g[0] * g[1] > 0 ? xt(g, Math.abs) / c.k : 0;
      if (y || v) {
        const t = c.translate(y, v);
        return this.transition(this.svg)
